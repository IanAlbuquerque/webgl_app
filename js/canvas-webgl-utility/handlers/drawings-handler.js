	...
	*/
	...
	{	
		...
		*/
		...
		{
			// Creates the buffers required for drawing.
			...
			// Bind the buffers content to the WebGL context
			// and points the Shaders Program's position and color attributes to the buffers.
			...
			// Draws the content of the buffers that were bind
